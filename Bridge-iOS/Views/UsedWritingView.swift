    ...
    var body: some View {
        ZStack {
            VStack(spacing : 0) {
                    ...
                    ScrollViewReader { value in
                        ...
                        VStack {
                            ...
                            TextEditor(text: $viewModel.description)
                                .id(1)
                                .onAppear() { UITextView.appearance().backgroundColor = UIColor(.systemDefaultGray) }
                                ...
                                .padding(.horizontal, 20)
                                .padding(.bottom, 5)
                                .onTapGesture { if viewModel.description == "Please write the content of your Post" { viewModel.description = "" } }
                                .foregroundColor(.darkGray)
                ...
                .onChange(of: viewModel.isUploadDone, perform: { _ in self.presentationMode.wrappedValue.dismiss() })
